...
The backend serves the generated widget artifact at
`ui://shd/active-projects/v1.html`. Generate the ignored runtime files before
...
The source is kept in `widgets/active-projects/source.html` and
`widgets/active-projects/widget.json`; generated `v1/` files are not committed.
...
Status Page, AirBase, Notes, Project overview, Files, Proposals, Activity,
Organizations and access, Gitea Issues and PDF Scheme Editor:
...
- `shd_render_airbase_widget` → `ui://shd/airbase/v1.html`;
...
- `shd_render_schemes_widget` → `ui://shd/pdf-scheme-editor/v1.html`;
...
- `shd_render_schemes_progress_widget` → `ui://shd/pdf-scheme-editor-progress/v1.html`;
- `shd_render_notes_tree_widget` → `ui://shd/notes-tree/v1.html`;
- `shd_render_airbase_preview_widget` → `ui://shd/airbase-preview/v1.html`.
