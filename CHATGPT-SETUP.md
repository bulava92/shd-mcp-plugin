...
2. ChatGPT calls the corresponding module render tool after the list tool
   ...
   `shd_render_status_page_widget`, `shd_render_airbase_widget`,
   `shd_render_notes_widget`, `shd_render_project_overview_widget`,
   `shd_render_files_widget`, `shd_render_proposals_widget`,
   `shd_render_activity_widget`, `shd_render_organizations_widget`,
   `shd_render_gitea_widget`, `shd_render_schemes_widget`, `shd_render_task_kanban_widget`,
   ...
   `shd_render_notes_tree_widget` or `shd_render_airbase_preview_widget`.
...
`ui://shd/airbase/v1.html`, `ui://shd/notes/v1.html`,
`ui://shd/project-overview/v1.html`, `ui://shd/files/v1.html`,
`ui://shd/proposals/v1.html`,
`ui://shd/activity/v1.html`, `ui://shd/organizations/v1.html`,
`ui://shd/gitea/v1.html`, `ui://shd/pdf-scheme-editor/v1.html`,
...
`ui://shd/pdf-scheme-editor-progress/v1.html`, `ui://shd/notes-tree/v1.html` and
`ui://shd/airbase-preview/v1.html`.
